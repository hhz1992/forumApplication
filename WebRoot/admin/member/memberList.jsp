...
<div class="pn-sp">
	...
	<div align="center">
		<t:pager pageSize="${pm.pageSize}" pageNo="${pm.pageNo}" url="${pageContext.request.contextPath}/user/memberManagerSerlet?method=memberList" recordCount="${pm.recordCount}"/>
