...
<div class="pn-sp">
	...
	<div align="center">
		共${replyCount }条 ${now}/${replyCount10 } 页&nbsp;<a href="<%=basePath %>/user/replyServlet?method=replyList" >首页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=nextReply&count=${now-1}">上一页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=nextReply&count=${now+1}">下一页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=nextReply&count=${replyCount10}">末页</a>
	</div>
	<div class="clear"></div>
</div>
