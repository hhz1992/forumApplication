...
<table>
      <tr align="center">
            ...
            <td>
                ...
                <input class="input" maxlength="14" name="loginName" id="loginName"  type="text" value=""/>  
...
<div class="pn-sp">
	...
	<div align="center">
		共${replyCount }条 1/${replyCount10 } 页&nbsp;<a href="<%=basePath %>/user/replyServlet?method=replyList" >首页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=nextReply&count=${replyCount10}">上一页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=nextReply&count=2">下一页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=nextReply&count=${replyCount10}">末页</a>
	</div>
	<div class="clear"></div>
</div>
