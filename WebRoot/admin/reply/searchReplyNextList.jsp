...
<div class="pn-sp">
	...
	<div align="center">
		共${replyCount }条 ${now}/${replyCount10 } 页&nbsp;<a href="<%=basePath %>/user/replyServlet?method=serach&loginName=${loginName}" >首页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=serachNextMemberReply&count=${now-1}&loginName=${loginName}">上一页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=serachNextMemberReply&count=${now+1}&loginName=${loginName}">下一页</a>&nbsp;<a href="<%=basePath %>/user/replyServlet?method=serachNextMemberReply&count=${replyCount10}&loginName=${loginName}">末页</a>
	</div>
	<div class="clear"></div>
</div>
