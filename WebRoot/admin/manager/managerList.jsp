...
<c:forEach items="${pm.datas}" var="manager">
<tbody class="pn-ltbody">
<tr align="center">
	<td><input type="checkbox" name="ids" value="1"/></td>
	<td>${manager.id }</td>
...
<div class="pn-sp">
	...
	<div align="center">
	<t:pager pageSize="${pm.pageSize}" pageNo="${pm.pageNo}" url="${pageContext.request.contextPath}/admin/managerServlet?method=managerList" recordCount="${pm.recordCount}"/>
	</div>
	<div class="clear"></div>
</div>
