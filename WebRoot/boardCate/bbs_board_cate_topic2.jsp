...
<!--main-->
    ...
    <table cellspacing="0" cellpadding="0" width="100%" style="table-layout: fixed">
     ...
     <c:if test="${reply.value.id==member.id}">
    ...
    <c:if test="${memlog==null}">
    	...
    	<span class="fl">
    		<div class="pg-3">	
				...
				<t:pager pageSize="${pm.pageSize}" pageNo="${pm.pageNo}" url="${pageContext.request.contextPath}/webIndexServlet?method=toCateTopicAuthor&id=${topic.id}" recordCount="${pm.recordCount}"/><tr><tr>
		   <td colspan="3">
