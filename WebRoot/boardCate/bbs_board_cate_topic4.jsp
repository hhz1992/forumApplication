    ...
    <c:if test="${memlog==null}">
    	...
    	<span class="fl">
    		<div class="pg-3">	
				...
				<t:pager pageSize="${pm.pageSize}" pageNo="${pm.pageNo}" url="${pageContext.request.contextPath}/webIndexServlet?method=toCateTopic&id=${topic.id}" recordCount="${pm.recordCount}"/>
		   <tr>
		   <td colspan="3">
