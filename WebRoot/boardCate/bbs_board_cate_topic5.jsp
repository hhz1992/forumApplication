...
<!--main-->
  ...
  <a name="pid135"></a>
    ...
    <c:if test="${memlog==null}">
    	...
    	<span class="fl">
    		<div class="pg-3">	
				...
				<t:pager pageSize="${pm.pageSize}" pageNo="${pm.pageNo}" url="${pageContext.request.contextPath}/webIndexServlet?method=toCateTopic&id=${topic.id}" recordCount="${pm.recordCount}"/><tr>
		   <td colspan="3">
    ...
    <form id="form2" action="<%=basePath %>user/replyServlet?method=addReply" method="post">
      ...
      <div align="center">
      <input type="submit" name="submit1" value="回复"/></div>
