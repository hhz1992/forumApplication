...
<!--main-->
    ...
    <table cellspacing="0" cellpadding="0" width="100%" style="table-layout: fixed">
      <tbody>
       ...
       <strong>下载附件：</strong>
      <a href="<%=basePath %>/user/memberRegisteServlet?method=down&fileName=${att.fileName }">  ${att.fileName }</a><br/>
       </c:if>
       </c:forEach>
		  </th>
        </tr>
     ...
     <c:if test="${floor==reply.key.floor}">
  ...
  <a name="pid135"></a>
    ...
    <c:if test="${memlog==null}">
    	...
    	<span class="fl">
    		<div class="pg-3">	
				...
				<t:pager pageSize="${pm.pageSize}" pageNo="${pm.pageNo}" url="${pageContext.request.contextPath}/webIndexServlet?method=toCateTopic&id=${topic.id}" recordCount="${pm.recordCount}"/><tr><tr>
		   <td colspan="3">
    ...
    <form id="form2" action="<%=basePath %>user/replyServlet?method=addReply" method="post">
      ...
      <FCK:editor instanceName="content" toolbarSet="site" height="400px" value=""></FCK:editor>
      <div align="center">
    ...
    <form id="form2" action="<%=basePath %>user/replyServlet?method=addReply" method="post">
      ...
      <FCK:editor instanceName="content" toolbarSet="site" height="400px" value=""></FCK:editor>
      <div align="center">
      <input type="submit" name="submit3" value="回复"/></div>
    ...
    <form id="form2" action="" method="post">
      ...
      <div align="center">
      <input type="submit" name="submit4" value="回复"/></div>
    ...
    <form id="form2" action="<%=basePath %>user/replyServlet?method=addReply" method="post">
      ...
      <FCK:editor instanceName="content" toolbarSet="site" height="400px" value=""></FCK:editor>
      <div align="center">
      <input type="submit" name="submit5" value="回复"/></div>
    ...
    <form id="form2" action="<%=basePath %>/user/replyServlet?method=addReply" method="post">
      ...
      <div align="center">
      <input type="submit" name="submit6" value="回复"/></div>
    ...
    <form id="form2" action="<%=basePath %>/user/replyServlet?method=addReply" method="post">
      ...
      <FCK:editor instanceName="content" toolbarSet="site" height="400px" ></FCK:editor>
      <div align="center">
      <input type="submit" name="submit7" value="回复"/></div>
    ...
    <form id="form2" action="" method="post">
      ...
      <div align="center">
      <input type="submit" name="submit8" value="回复"/></div>
    ...
    <form id="form2" action="<%=basePath %>/user/replyServlet?method=addReply" method="post">
      ...
      <FCK:editor instanceName="content" toolbarSet="site" height="400px" ></FCK:editor>
      <div align="center">
      <input type="submit" name="submit9" value="回复"/></div>
