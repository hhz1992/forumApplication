...
<!--main-->
    ...
    <ul id="set-menu">
      ...
      <li class="current" id="pro_modify"><a href="<%=basePath %>/user/memberRegisteServlet?method=attachmentList">我的附件</a></li>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
      <tbody>
        <tr class="tac" id="infolist">
          <td class="current"><a href="#" style="cursor: pointer">我上传的附件</a></td>
        </tr>
      </tbody>
    </table>
    </div>
     <div class="set-tab-box">
      <table class="set-table2" cellspacing="0" cellpadding="0" width="100%" border="0" style="margin-top:10px;">
        <tbody>
          ...
          <tr>
            ...
            <td width="15%"><strong>所属帖子标题</strong></td>
            <td width="16%"><strong> 附件描述</strong></td>
            <td width="15%"><strong>上传时间</strong></td>
            <td width="39%"><strong>上传路径</strong></td>
          ...
          <tr>
            ...
            <c:if test="${topic.id==attachment.topicId}"><a href="<%=basePath %>webIndexServlet?method=toCateTopic&id=${topic.id }"  target="_blank">${topic.title}</a></c:if>
            </c:forEach>
             </td>
            <td>
            ...
            <td class="pn-lopt"><a href="<%=basePath %>/user/memberRegisteServlet?method=deleteAttachment&topicId=${attachment.topicId }" class="pn-loperator">删除</a></td>
          </tr>
          </c:forEach>
        </tbody>
      </table>
	  <div class="page">
              ...
              <ul>
           <t:pager pageSize="${pm.pageSize}" pageNo="${pm.pageNo}" url="${pageContext.request.contextPath}/user/memberRegisteServlet?method=attachmentList" recordCount="${pm.recordCount}"/>   
              </ul>
