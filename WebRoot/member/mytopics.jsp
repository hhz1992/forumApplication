...
<!--main-->
    ...
    <ul id="set-menu">
      ...
      <li class="current" id="pro_modify"><a href="<%=basePath%>webIndexServlet?method=mytopic">我的主题</a></li>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
      <tbody>
        <tr class="tac" id="infolist">
          <td class="current" ><a href="#" style="cursor: pointer">我发表的主题</a></td>
          <td ><a href="<%=basePath %>bbs/bbs_post.jsp" style="cursor: pointer">发表主题</a></td>
        </tr>
      </tbody>
    </table>
    </div>
     <div class="set-tab-box">
      <table class="set-table2" cellspacing="0" cellpadding="0" width="100%" border="0" style="margin-top:10px;">
        <tbody>
          <tr>
            <td width="40%"><strong>标 题</strong></td>
            <td width="15%"><strong> 版块</strong></td>
            <td width="18%"><strong>发表时间</strong></td>
            <td width="27%"><strong>上传附件</strong></td>
          </tr>
          <c:forEach items="${topicList}" var="topic" >
          
          <tr>
            <td><a href="<%=basePath %>webIndexServlet?method=toCateTopic&id=${topic.id }"  target="_blank">${topic.title }</a> </td>
            <td> 
            ...
            <td> ${topic.pubTime }</td>
            <td> <a href="<%=basePath %>user/memberRegisteServlet?method=attachment&topicId=${topic.id}">上传附件</a></td>
          </tr>
	  ...
	  <div class="page">
              ...
              <ul>
           <t:pager pageSize="${pm.pageSize}" pageNo="${pm.pageNo}" url="${pageContext.request.contextPath}/webIndexServlet?method=mytopic" recordCount="${pm.recordCount}"/>
              </ul>
